    ...
    for event in pygame.event.get():
        if event.type == QUIT:
            ...
            if k == pygame.K_2:
                ...
                fluidsynth.stop_Note(Note("D"))

            if k == pygame.K_3:
                KEYS[2] = 0
                keyslice.notesActive[2] = False
                fluidsynth.stop_Note(Note("E"))

            if k == pygame.K_4:
                KEYS[3] = 0
                keyslice.notesActive[3] = False
                fluidsynth.stop_Note(Note("F"))

            if k == pygame.K_5:
                KEYS[4] = 0
                keyslice.notesActive[4] = False
                fluidsynth.stop_Note(Note("G"))

            if k == pygame.K_6:
                KEYS[5] = 0
                keyslice.notesActive[5] = False
                fluidsynth.stop_Note(Note("A"))

            if k == pygame.K_7:
                KEYS[6] = 0
                keyslice.notesActive[6] = False
                fluidsynth.stop_Note(Note("B"))
